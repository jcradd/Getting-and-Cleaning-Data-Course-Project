...
Copies of readme.txt and features.info from the data files are included below for reference.  These provide considerable detail on the original source data.
...
# Documentation from original source

## **********readme.txt from source**********
